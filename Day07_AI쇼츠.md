...
> **Day 6 주문서를 만들었다면 오늘 주제는 그 주문서의 주제 그대로**입니다. Day 6을 건너뛰었다면 오늘 주제는 `한옥 처마가 여름빛은 막고 겨울빛은 들이는 이유` 하나입니다. 어느 쪽이든 새로 고르느라 시간 쓰지 마세요.
...
2. 기다리지 말고 C2~C5도 차례로 걸어 둡니다. **컷마다 Claude에게 `C2 프롬프트만 클립보드에 복사해 주세요`라고 새로 요청한 뒤** 붙여넣습니다 — 복사를 새로 안 하면 직전 컷과 같은 문장이 다시 붙습니다.
