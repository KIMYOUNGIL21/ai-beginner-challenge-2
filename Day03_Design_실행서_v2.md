...
- 화면 위에 주제 입력칸, 본문 다시 만들기 버튼, 전체 PNG 저장 버튼, 캡션 복사 버튼을 만듭니다.
- 전체 PNG 저장을 누르면 1080×1350 PNG 5장이 든 ZIP 파일 하나를 내려받게 만듭니다.
...
## 8단계 — 결과 화면에서 PNG 5장을 저장합니다

1. 결과 화면의 **전체 PNG 저장**을 누릅니다.
2. 다운로드 허용을 물으면 허용합니다.
3. 다운로드 폴더에 이미지 5장 또는 5장이 든 ZIP이 생겼는지 봅니다.
4. ZIP이면 두 번 눌러 풉니다.
5. `D03_닉네임_01.png`부터 `D03_닉네임_05.png`로 이름을 바꿉니다.
6. **캡션 복사**를 누르고 메모장에 붙여넣어 실제 복사됐는지 확인합니다.
