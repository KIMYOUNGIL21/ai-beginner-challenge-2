...
입력은 `주제 / 대상 / 눈으로 보여 줄 대비 / 마지막 한마디 / 말투` 다섯 가지입니다. `:` 뒤만 내 것으로 바꾸면 되고, 예시 그대로 보내도 완주할 수 있습니다.

결과는 `input/brief.json`, `output/shorts-brief.html`, 두 파일을 복사한 `day06-handoff` 폴더입니다. 자세한 프롬프트는 온라인 Day 6 실행서를 따릅니다.
