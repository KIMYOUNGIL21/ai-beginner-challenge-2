...
- **이 과정에서 언제 봄:** Day 3에서 인스타 카드뉴스 5장을 만들 때 사용합니다.
...
- **이 과정에서 언제 봄:** Day 2에서 `my-profile.txt`를 넣고 내 콘텐츠 주제 3개를 받을 때 봅니다.
- **왕초보가 지금 할 행동:** `프로젝트 → 새 프로젝트 → 오른쪽 컨텍스트 + (파일 추가)` 순서로 소개 파일 하나만 넣습니다.
